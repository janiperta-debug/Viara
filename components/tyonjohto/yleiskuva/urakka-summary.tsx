import { URAKKA } from "@/lib/tyonjohto-mock";

function LegendaKohta({
  vari,
  label,
  luku,
}: {
...
export function UrakkaSummary() {
  const { valmisProsentti, valmis, kaynnissa, aloittamatta } = URAKKA;

  return (
    <section className="metal-card rounded-2xl p-6">
      <p className="text-sm text-muted">Hyvää huomenta,</p>
      <h1 className="text-2xl font-semibold text-foreground">Jani</h1>
