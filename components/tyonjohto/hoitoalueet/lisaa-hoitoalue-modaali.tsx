      ...
      <div className="metal-card relative z-10 my-4 w-full max-w-2xl rounded-2xl p-6">
        ...
        {asiakkuudet.length === 0 ? (
          ...
          <div className="mt-5 space-y-4">
            ...
            {valittu?.rajaGeoJson && <div className="space-y-2"><div className="flex items-center gap-2 text-sm font-medium text-foreground"><MapPin className="h-4 w-4 text-primary" /> Kiinteistörajan esikatselu</div><MmlHoitoalueEsikatselu geometry={valittu.rajaGeoJson} /><div className="rounded-xl border border-primary/20 bg-primary/5 px-4 py-3 text-xs leading-5 text-muted"><span className="font-medium text-foreground">MML:n kiinteistöraja.</span> Tarkista kartalta, että löydetty kohde vastaa hoidettavaa aluetta. Hyväksytty raja tallennetaan Viaran hoitoalueen GeoJSON-rajaukseksi.</div></div>}
